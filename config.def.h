...
// static const char *tags[] = { "I", "II", "III", "VI", "V", "VI", "VII", "VIII", "IX" };
...
static const char *dmenucmd[] = { "dmenu_run", "-l", dmenulines,"-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_accent, "-sf", col_gray4, NULL };
